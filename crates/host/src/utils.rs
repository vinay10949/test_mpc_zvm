...
pub fn simulate_eth_accounts(seed: usize, num_accounts: usize) -> IndexMap<String, EthAccount> {
    let mut rng: rand::rngs::StdRng = rand::SeedableRng::from_seed([seed as u8; 32]);
...
pub fn generate_account_state_root_hash(accounts: &IndexMap<String, EthAccount>) -> String {
